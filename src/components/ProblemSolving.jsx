...
const ProblemSolving = () => {
  ...
  return (
    <section
      id="problem-solving"
      className="py-10 md:py-10 bg-white dark:bg-gray-950 "
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {platforms.length === 0 ? (
            ...
            platforms.map((platform, index) => (
              <div
                key={platform.id}
                className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm hover-lift border border-gray-200 dark:border-gray-700 animate-scale-in stagger-${Math.min(
                  index + 1,
                  10
                )}`}
              >
                ...
                <div className="p-8 pt-12 flex flex-col items-center text-center">
                  ...
                  {/* Description */}
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-8 px-2">
                    {platform.description}
                  </p>

                  {/* Divider Line */}
                  <div className="w-full border-t border-gray-300 dark:border-gray-600 mb-4"></div>
